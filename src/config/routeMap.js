...
const Registry = Loadable({loader: () => import(/*webpackChunkName:'Env'*/'@/views/appdeliver/imagecenter/registry'),loading: Loading});
const Registrycert = Loadable({loader: () => import(/*webpackChunkName:'Env'*/'@/views/appdeliver/imagecenter/registrycert'),loading: Loading})
const Env = Loadable({loader: () => import(/*webpackChunkName:'Env'*/'@/views/env'),loading: Loading});
...
const Projectbuild = Loadable({loader: () => import(/*webpackChunkName:'Env'*/'@/views/appdeliver/ci/projectbuild'),loading: Loading});
...
export default [
  ...
  { path: "/appdeliver/ci/projectbuild", component: Projectbuild, roles: ["admin","editor","guest"]},
